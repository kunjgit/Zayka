...
@font-face {
    ...
    <section class="food-search text-center" >
        <div class="container" style="background:transparent">
            ...
            <h2  style="background:transparent"><a href="#" class="text-white" style="  font-family: logofont;  color:#7ed756; letter-spacing: 0.5mm;">Foods on "<?php echo $category_title; ?>"</a></h2>
    ...
    <section class="food-menu" style="background-color:black;">
        <div class="container">
            <h2 class="text-center" style="  font-family: logofont;  color: aqua; letter-spacing: 0.5mm;">Food Menu</h2>
            ...
            <?php 
                ...
                if($count2>0)
                {
                    ...
                    while($row2=mysqli_fetch_assoc($res2))
                    {
                        ...
                        <div style="background-color:black;" class="food-menu-box">
