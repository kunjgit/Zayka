...
<div class="main-content"  style="background-color:black; color:white; text-align:center; " >
    <div class="wrapper"  style="background-color:black; color:white;   text-align:center; " >
        <h1  style="  font-family: logofont;  color:#7ed756; letter-spacing: 0.5mm; " >Update Category</h1>
        ...
        <form action="" method="POST" enctype="multipart/form-data"  style="background-color:black; color:white; ">
