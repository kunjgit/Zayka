...
<div class="main-content">
    <div class="wrapper">
        <h1 style="  font-family: logofont;  color:#7ed756; letter-spacing: 0.5mm; text-align:center;"  >Update Food</h1>
        <br><br>
        ...
        <table class="tbl-30" style="background-color:black; color:white; margin-left: auto; margin-right: auto; ">
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" name="submit" value="Update Food" class="btn-secondary" style="font-family: taglinefont;">
                </td>
            </tr>
